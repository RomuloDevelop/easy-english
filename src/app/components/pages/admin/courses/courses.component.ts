...
import { selectCoursesTable, CoursesTableRow } from '../../../../state/admin/admin.selectores';
import { setCourse, updateStatus, deleteCourse } from '../../../../state/admin/courses/course.actions';
...
export class CoursesComponent implements OnInit {
  ...
  editCourse(course: CoursesTableRow) {
    this._router.navigate(['create-course', course.id], {relativeTo: this.route})
  }
